...
Codex 向けの repo rule は `AGENTS.md` にあります。repo-local skill は `skills/blog-template/SKILL.md` です。skill UI metadata は `skills/blog-template/agents/openai.yaml` にあります。
